...
import { BookOpen, Clock, Eye, LogOut, Mic2, Plus, Sparkles, Trash2 } from "lucide-react";
import Link from "next/link";
import { useRouter } from "next/navigation";
import { createClient } from "@/lib/supabase/client";
import toast from "react-hot-toast";
import { VoiceStudioDialog } from "@/components/voice/VoiceStudioDialog";
    ...
    <div className="library-shell">
      <nav className="library-nav">
        ...
        <div className="library-nav-actions">
          ...
          >
            <Mic2 size={14} /> Kendi Sesini Oluştur
          </button>
      ...
      <VoiceStudioDialog open={voiceStudioOpen} userName={userName} onClose={() => setVoiceStudioOpen(false)} />
    </div>
  );
}
